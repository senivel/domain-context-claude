...
- [x] **CONT-05**: Architecture/concepts page — bridge pattern, hook lifecycle, .context/ structure
- [x] **CONT-06**: Domain Context spec overview — what the spec is and how this tool implements it
